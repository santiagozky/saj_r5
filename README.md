...
This should also work for rebranded inverters like the greenheiss R5 (like mine!)

## Installation
this integration is not on hacs, so use a custom repository or just copy the saj_r5 folder into your custom_components folder.

## disclaimer
this integration was generated using AI. do what you want with this information. 
